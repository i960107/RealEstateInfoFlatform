...
<td colspan="6" width="100%" height="500px"><script
	...
	<table border=1 width="100%" height="100%">
		<tr>
			<td colspan="2"  height="30px"><a href="javascript:typeAdd(1)" id="sel">매매</a> <a
				href="javascript:typeAdd(2)" id="rent">전월세</a> <a id="presel" href="javascript:typeAdd(3)">신축분양</a>
			</td>
		</tr>
		<tr>
			<%
